...
mainMenu:
        ;;Выбор видеорежима
        mov ah, 0x00
        mov al, 0x09 ;0x08/0х03 - мой режим
        int 0x10
        
        mov ah, 0x0B
        mov bh, 0x00
        mov bl, 0x00 ;  Задний фон (синий цвет) 0 - черный, 1 - синий, 2 - зеленый, 3 - желтый, 4 - красный, 5 - фиолетовый, 6 - коричневый, 7 - светло-серый, 8 - темно-серый, 9 - светло-синий, A - светло-зеленый, B - светло-желтый, C - светло-красный, D- светло-фиолетовый, E - светло-коричневый, F – Белый.ц
        int 0x10
